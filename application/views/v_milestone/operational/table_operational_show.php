...
<script>
    ...
    function cek_milestone(id,week,detail) {  
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url('c_milestone/operational/cek_milestone_id') ?>",
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                },
                {
                    ...
                    "width":'8%',
                    "render": function (data,type,row) { 
                        return `<span class=""><span class="badge badge-pill badge-info">`+row.tahun_milestone+`</span></span>`;
                    }
                },
                ],
    ...
    $(document).on('click.ev', '.detail',function(e){
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url('c_milestone/operational/check_detail') ?>",
            data: {id:id_do},
            success: function (response) {
    ...
    $('#data tbody').on('click.ev','.tambah-milestone',function(e){
        ...
        if ( row.child.isShown() ) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('c_milestone/operational/all_detail_sales') ?>",
                data: {id:id},
                success: function (response) {
    ...
    $('#data tbody').on('click.ev','.tambah',function (e) {  
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url('c_milestone/operational/check_detail_week') ?>",
    ...
    $('.btn-simpan').on('click.ev',function (e) {  
        ...
        if(status_id == null){
            ...
            if( ket_update == '' && kendala == "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('c_milestone/operational/save_detail') ?>",
