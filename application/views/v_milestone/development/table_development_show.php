...
<script>
    ...
    function cek_milestone(id,week,detail) {  
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url('c_milestone/development/cek_milestone_id') ?>",
    ...
    $(document).on('click.ev', '.detail',function(e){
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url('c_milestone/development/check_detail') ?>",
            data: {id:id_do},
            success: function (response) {
    ...
    $('#data tbody').on('click.ev','.tambah-milestone',function(e){
        ...
        if ( row.child.isShown() ) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('c_milestone/development/all_detail_sales') ?>",
                data: {id:id},
                success: function (response) {
    ...
    $('#data tbody').on('click.ev','.tambah',function (e) {  
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url('c_milestone/development/check_detail_week') ?>",
    ...
    $('.btn-simpan').on('click.ev',function (e) {  
        ...
        if(status_id == null){
            ...
            if( ket_update == '' && kendala == "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('c_milestone/development/save_detail') ?>",
