...
class Milestone_oprational_model extends CI_Model {

    public $table = 'milestone_oprational';
    public $primary_key = 'id';
    public $order_by = 'id';
    public $order_type = 'ASC';
    public $search_field = 'project';
    public $column_order = ['project','milestone','name_code_tl.id = milestone_oprational.code_tl_id','kategori.id = milestone_oprational.kategori_id']; //set column field database for datatable orderable
    public $column_search = ['project','milestone','name_code_tl.id = milestone_oprational.code_tl_id','kategori.id = milestone_oprational.kategori_id']; //set column field database for datatable searchable 
    ...
    function lists($select = '*', $where = null, $limit = 10 ,$offset = 0)
    {
        $this->db->select($select)
                 ->join('name_code_tl', 'name_code_tl.id = milestone_oprational.code_tl_id')
                 ->join('kategori', 'kategori.id = milestone_oprational.kategori_id')
                 ->limit($limit,$offset);
    ...
    function list_count($where = null, $is_where = false) {
        $this->db->join('name_code_tl', 'name_code_tl.id = milestone_oprational.code_tl_id')->join('kategori', 'kategori.id = milestone_oprational.kategori_id');
