...
class Users_model extends CI_Model {
    ...
    public $order_by = 'username';
    public $order_type = 'DESC';
    public $search_field = 'name';
    public $column_order = ['username']; //set column field database for datatable orderable
    public $column_search = ['username']; //set column field database for datatable searchable 
