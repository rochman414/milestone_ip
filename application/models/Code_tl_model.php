...
class Code_tl_model extends CI_Model {

    public $table = 'name_code_tl';
    public $primary_key = 'id';
    public $order_by = 'code_tl';
    public $order_type = 'ASC';
    public $search_field = 'name';
    public $column_order = ['code_tl','name','division_milestone.id = name_code_tl.division_id','status']; //set column field database for datatable orderable
    public $column_search = ['code_tl','name','division_milestone.id = name_code_tl.division_id','status']; //set column field database for datatable searchable 
    ...
    function lists($select = '*', $where = null, $limit = 10 ,$offset = 0)
    {
        $this->db->select($select)
                 ->join('division_milestone', 'division_milestone.id = name_code_tl.division_id')
                 ->limit($limit,$offset);
    ...
    function list_count($where = null, $is_where = false) {
        $this->db->join('division_milestone', 'division_milestone.id = name_code_tl.division_id');
